...
export const GENERATE_SUPPLIER_REGISTER = "[Documents] GENERATE_SUPPLIER_REGISTER";
...
export class GenerateSuppliersRegister implements Action {
  readonly type = GENERATE_SUPPLIER_REGISTER;
}
